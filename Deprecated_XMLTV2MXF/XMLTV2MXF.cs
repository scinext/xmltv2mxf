...
namespace XMLTV2MXF
{
    ...
    class XMLTV2MXF_Main
    {
        ...
        {
            Console.WriteLine("Processing: " + XMLTVfilename);
        ...
        */
        ...
        static void writeScheduleForChannel(XmlTextWriter theWriter, string service, string channelStr)
        {
            ...
            // output debug info
            if(ShowCount>0)
                Console.WriteLine("Processed Channel: " + channelStr + " wrote " + ShowCount.ToString() + " entries ");
        }
        ...
        static void readChannelSettings(string fName)
        {
                ...
                Console.WriteLine("About to open: " + fName);
                ...
                while (xmlChannels.Read())
                {
                    if (xmlChannels.NodeType == XmlNodeType.Element && xmlChannels.Depth < 3)
                    {
                        ...
                        {
                            //Console.WriteLine(xmlChannels.ReadOuterXml());
                            ...
                            //Console.WriteLine("Processed Channel :" + newChannel.name_ + " from " + fName);
                        }
                    }
